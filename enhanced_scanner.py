...
Combines the existing compliance scanner with the new endpoint analyzer
to provide comprehensive OSS compliance reporting with detailed endpoint enumeration.
"""
...
class EnhancedComplianceScanner:
    """
    Enhanced scanner that combines basic compliance checking with
    ...
    def __init__(self, repo_root: str, virtual_repos: Dict = None, 
        ...
        self.basic_scanner = ComplianceScanner(
            repo_root=repo_root,
            virtual_repos=virtual_repos,
    ...
    def scan_comprehensive(self) -> Dict:
        ...
        basic_report = self.basic_scanner.scan()
